export default {
  ...
  elements_cn: [
    ...
    { id: "el_model", type: "text", name: "Model Title", text: "型号: S403 | 热式气体质量流量计", xMm: 1, yMm: 4.8, fontSize: 5, bold: true, expanded: false },
    { id: "el_item_no", type: "text", name: "Item No.", text: "订货号: S695 4035 (空气)", xMm: 1, yMm: 7.2, fontSize: 4, bold: true, expanded: false },
    { id: "el_serial", type: "text", name: "Serial No.", text: "序列号: {{serial}}", xMm: 1, yMm: 8.9, fontSize: 4, bold: true, expanded: false },
