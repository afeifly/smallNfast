...
import com.cs.canalyzer.export.ExportAction;
 ...
 * @author dell
 */
public class JTable2PdfExportAction extends ExportAction {
...
//    }
    ...
    public JTable2PdfExportAction(Base base, JDialog exportDialog, int choice) {
        super(base, exportDialog, choice);

    }
    public static final char cubeSymbol = 0xB3;
    private void newPdfPage(Vector title, Vector datev) throws DocumentException, IOException {
