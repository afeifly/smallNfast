...
//                }
    ...
    private void showPage(ArrayList<JTable> tables,int index){
          JPanel mainpanel = new JPanel (new BorderLayout());
          JPanel btnpanel = new JPanel (new GridLayout(0,8));
          JButton pb = new JButton(java.util.ResourceBundle.getBundle("com/cs/canalyzer/CAATexts").getString("Previous"));
          ...
          JButton nb = new JButton(java.util.ResourceBundle.getBundle("com/cs/canalyzer/CAATexts").getString("Next"));
